...
@chat_router.get("/", response_model=list[ChatRead], status_code=status.HTTP_200_OK, summary="Get all chats")
async def get_chats(
...
@chat_router.post("/", response_model=ChatRead, status_code=status.HTTP_201_CREATED, summary="Create a new chat")
